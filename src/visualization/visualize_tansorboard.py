...
# init model
model = SiameseModel().to("cuda")
model.load_state_dict(torch.load("C:\\Users\\shany\\PycharmProjects\\emotion_embedder\\src\\models\\siamese_network_triplet.pt"))
model.eval()

# load dataset
val_csv_path = "/storage-local/rbuzaglo/temp/dataset/val_annotations.csv"
