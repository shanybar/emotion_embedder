...
class EmotionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        input_1 = self.feature_extractor(
            signal_1, sampling_rate=self.feature_extractor.sampling_rate,
            max_length=64000, truncation=True, return_tensors="pt")
        input_2 = self.feature_extractor(
            signal_2, sampling_rate=self.feature_extractor.sampling_rate,
            max_length=64000, truncation=True, return_tensors="pt")
...
if __name__ == "__main__":
    ...
    dataset = EmotionDataset(ANNOTATIONS_FILE)
